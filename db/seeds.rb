...
Hearo.create(username: 'sfreud', password: 'password', first_name: 'Sigmund', last_name: 'Freud', specialty_id: 2, gender_id: 1, therapist_code: 'YYZ', verified: true, dob: "1980-06-26")
